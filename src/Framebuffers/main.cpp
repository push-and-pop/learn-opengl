...
int main() {
  ...
  // -------------------------
  Shader shader("shader/Framebuffers/framebuffers.vs",
                "shader/Framebuffers/framebuffers.fs");
  Shader screenShader("shader/Framebuffers/framebuffers_screen.vs",
                      "shader/Framebuffers/framebuffers_screen.fs");
